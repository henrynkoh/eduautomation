...
export async function PUT(request: Request, { params }: RouteParams) {
  try {
    ...
    // In a real application, we would update the course in a database
    // For simplicity, we're just returning the updated course
...
export async function DELETE(request: Request, { params }: RouteParams) {
  ...
  // In a real application, we would delete the course from a database
